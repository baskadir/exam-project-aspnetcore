...
using Exam.Data.InitializeUserInfo;
...
namespace Exam.UI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<ExamDbContext>(options => options.UseSqlite(Configuration.GetConnectionString("connectionString"), options => options.MigrationsAssembly("Exam.Data")));
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, UserManager<AppUser> userManager)
        {
            ...
            InitializeUser.CreateUser(userManager);
